...
const CHANNEL_IDS = ["1068169300", "1490335959", "1389121686", "2434134765"];
const GROUP_IDS = ["1503490278", "1172788225","1115770280"];
    ...
    if (fs.existsSync(DB_FILE)) {
      ...
      if (fileContent) {
        try {
          ...
          console.error("JSON parsing error, resetting stats to defaults", error);
        }
      }
    }
  } catch (err) {
...
async function main() {
  ...
  console.log("✅ Telegram hisobga muvaffaqiyatli ulandi!");
